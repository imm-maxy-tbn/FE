                ...
                <div class="informasi-pribadi">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type="text" placeholder="Nama Lengkap" id="nama" name="nama" required /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><span class="input-icon"><i class="fas fa-lock"></i></span></td>
                            <td><input type="password" placeholder="Password" id="password_confirmation" name="password_confirmation" required /></td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="informasi-alamat">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="text" placeholder="Alamat Lengkap" id="alamat" name="alamat" required /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <button type="submit" class="btn btn-primary" id="simpanBtn">Simpan Data</button>
                </div>
            </div>
        </form>
